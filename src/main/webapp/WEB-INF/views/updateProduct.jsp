...
<body>
	...
	<section class="container w3-margin-top">
			...
			<fieldset>
				...
				<div class="form-group">
					<div class="col-lg-10">
						<form:input id="productId" path="productId" type="hidden"
							class="w3-input w3-border" value='${product.productId}' />
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="name" path="name" type="text"
							class="w3-input w3-border" value="${product.name}" />
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="unitPrice" path="unitPrice" type="text"
							class="w3-input w3-border" value="${product.description}" />
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="manufacturer" path="manufacturer" type="text"
							class="w3-input w3-border" value="${product.manufacturer}" />
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="category" path="category" type="text"
							class="w3-input w3-border" value="${product.category}" />
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="unitsInStock" path="unitsInStock" type="text"
							class="w3-input w3-border" value="${product.unitsInStock}"/>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						...
						value="${product.description}" class="w3-input w3-border"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:radiobutton path="condition" value="New" checked="${product.condition=='New'}" />
						New
						<form:radiobutton path="condition" value="Old" checked="${product.condition=='Old'}"/>
						Old
						<form:radiobutton path="condition" value="Refurbished" checked="${product.condition=='Refurbished'}"/>
						Refurbished
					</div>
				</div>
				
				<div class="form-group">
					<label class="control-label col-lg-2" for="Product Image"><spring:message
							code="addProdcut.form.productImage.label" /></label>
					<div class="col-lg-10">
						<form:input id="Product Image" path="productImage" rows="2" 
						value="${product.productImage}" class="w3-input w3-border"/>
					</div>
				</div>
